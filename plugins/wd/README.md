...
### [oh-my-zsh](https://github.com/ThoTrung/ohmyzsh)
...
_You might need to add `setopt AUTO_PUSHD` to your `.zshrc` if you are not using [oh-my-zsh](https://github.com/ThoTrung/ohmyzsh)._
